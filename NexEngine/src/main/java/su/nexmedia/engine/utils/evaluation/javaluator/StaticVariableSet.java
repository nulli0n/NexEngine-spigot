...
/**
 * A static variable set. <br>
 * Here, static means that the values of variables are set before starting to
...
public class StaticVariableSet<T> implements AbstractVariableSet<T> {
     ...
     * @param value        The variable value (null to remove a variable from the
     *                     set).
     */
