...
/**
 * The parameters of an evaluator. <br>
 * An evaluator may have different parameters as the supported operators, the
 * supported functions, etc ...
 *
...
public class Parameters {
    ...
    /**
     * Constructor. <br>
     * This method builds an instance with no operator, no function, no constant, no
     * translation and no bracket <br>
    ...
    /**
     * Sets the translated term for a function. <br>
     * Using this method, you can localize the names of some built-in functions. For
     * instance, for french people,you can use this method to use "somme" instead of
     * "sum" with the SUM built-in function of DoubleEvaluator.
     *
    ...
    /**
     * Sets the function argument separator. <br>
