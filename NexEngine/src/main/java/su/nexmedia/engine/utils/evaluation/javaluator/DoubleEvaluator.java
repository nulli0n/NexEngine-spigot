 ...
 * Warning: Exponentiation is implemented using java.lang.Math.pow which has
 * some limitations (please read oracle documentation about this method to known
 * details).<br>
 * For example (-1)^(1/3) returns NaN.</li>
 * <li>%: Modulo</li>
 * </ul>
 * Built-in functions:
 * <ul>
...
public class DoubleEvaluator extends AbstractEvaluator<Double> {
    ...
    /**
     * Returns the trigonometric cosine of an angle. The angle is expressed in
     * radian.
     */
    public static final Function COSINE  = new Function("cos", 1);
    /**
     * Returns the trigonometric tangent of an angle. The angle is expressed in
     * radian.
     */
    public static final Function TANGENT = new Function("tan", 1);
    /**
     * Returns the trigonometric arc-cosine of an angle. The angle is expressed in
     * radian.
     */
    public static final Function ACOSINE = new Function("acos", 1);
    /**
     * Returns the trigonometric arc-sine of an angle. The angle is expressed in
     * radian.
     */
    public static final Function ASINE   = new Function("asin", 1);
    /**
     * Returns the trigonometric arc-tangent of an angle. The angle is expressed in
     * radian.
     */
    ...
    /**
     * The <a href="http://en.wikipedia.org/wiki/Modulo_operation">modulo
     * operator</a>.
     */
    ...
    /**
     * Gets a copy of DoubleEvaluator standard default parameters. <br>
     * The returned parameters contains all the predefined operators, functions and
     * constants. <br>
    ...
    /**
     * Gets a copy of DoubleEvaluator default parameters. <br>
     * The returned parameters contains all the predefined operators, functions and
     * constants. <br>
     * Each call to this method create a new instance of Parameters.
     *
     ...
     *
     * @see
     * net.astesana.javaluator.AbstractEvaluator#evaluate(net.astesana.javaluator.
     * Constant)
     */
    @Override
    ...
    /**
     * The order or operations (operator precedence) is not clearly defined,
     * especially between the unary minus operator and exponentiation operator (see
     * <a href=
     * "http://en.wikipedia.org/wiki/Order_of_operations#Exceptions_to_the_standard">http://en.wikipedia.org/wiki/Order_of_operations</a>).
     * These constants define the operator precedence styles.
     */
    public static enum Style {
        /**
         * The most commonly operator precedence, where the unary minus as a lower
         * precedence than the exponentiation. <br>
         * With this style, used by Google, Wolfram alpha, and many others, -2^2=-4.
         */
        STANDARD,
        /**
         * The operator precedence used by Excel, or bash shell script language, where
         * the unary minus as a higher precedence than the exponentiation. <br>
