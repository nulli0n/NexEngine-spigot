...
public class Function {
     ...
     * @throws IllegalArgumentException if argumentCount is lower than 0 or if the
    ...
    /**
     * Constructor. <br>
     * This constructor builds a function with a variable arguments count. <br>
     ...
     * @param maxArgumentCount The function's maximum argument count
     *                         (Integer.MAX_VALUE to specify no upper limit).
     * @throws IllegalArgumentException if minArgumentCount is less than 0 or
     *                                  greater than maxArgumentCount or if the
     *                                  function name is null or empty.
     */
